            ...
            : [
                ...
                MENU_SEPERATOR,
                {
                  ...
                  menu: [
                    ...
                    MENU_SEPERATOR,
                    {
                      // NOTES - Add menu context here when icon is sorted
                      action: () =>
                        window.open(
                          decodeURIComponent("https://x.com"),
                          "_blank",
                          "noopener,noreferrer"
                        ),
                      icon: getIconByFileExtension("x-144"),
                    ...
                    },
                    {
                      ...
                      action: () =>
                        window.open(
                          decodeURIComponent(
                            "https://github.com/veloraOS/velora"
                          ),
                          "_blank",
                          "noopener,noreferrer"
                        ),
                      icon: getIconByFileExtension("github-144"),
                    ...
                    },
                    {
                      ...
                      action: () =>
                        window.open(
                          decodeURIComponent(
                            "https://velora-1.gitbook.io/veloraos"
                          ),
                          "_blank",
                          "noopener,noreferrer"
                        ),
                      icon: getIconByFileExtension("info"),
                      label: "Gitbook",
                    },
                    {
                      action: () =>
